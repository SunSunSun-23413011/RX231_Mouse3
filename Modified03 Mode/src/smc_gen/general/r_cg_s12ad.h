...
#define _000D_AD_TRSB_TRGAN1                 (0x000DU) /* Compare match with or input capture from TPUn.TGRA
                                                          (n=0 to 4) */
...
#define _0800_AD_TRSA_TRG4ABN                (0x0800U) /* Compare match between MTU4.TADCORA and MTU4.TCNT or
                                                          compare match between MTU4.TADCORB and MTU4.TCNT */
#define _0D00_AD_TRSA_TRGAN1                 (0x0D00U) /* Compare match with or input capture from TPUn.TGRA
                                                          (n=0 to 4) */

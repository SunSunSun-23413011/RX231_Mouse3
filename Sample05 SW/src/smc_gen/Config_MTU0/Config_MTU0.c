...
void R_Config_MTU0_Create(void)
{
    ...
    MTU0.TCR.BYTE = _03_MTU_PCLK_64 | _00_MTU_CKEG_RISE | _40_MTU_CKCL_B;
    ...
    MTU0.TGRA = _001E_TGRA0_VALUE;
    MTU0.TGRB = _001E_TGRB0_VALUE;
    MTU0.TGRC = _001E_TGRC0_VALUE;
    MTU0.TGRD = _001E_TGRD0_VALUE;
    MTU0.TGRE = _001E_TGRE0_VALUE;
    MTU0.TGRF = _001E_TGRF0_VALUE;
